...
const { HAILUO_KV, getTokens, setRefreshStatus, clearTokenCache } = require('./kv-store');
...
async function handleAudioSpeech(req, res, apiUrl) {
  console.log(`Handling audio speech request with API URL: ${apiUrl}`);
